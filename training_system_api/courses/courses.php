...
<script>
    ...
    .then(data=>{
        ...
        if (data.status ==="success"&& data.data.length>0){
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-grid gap-2 d-md-block">
                                <a href="edit_course.php?id=${item.id}" class="btn btn-warning">Edit</a>
                                <a href="delete_course.php?id=${item.id}" class="btn btn-danger">Delete</a>
                            </div>
                        </td>
                        <?php endif; ?>
                    </tr>
            ...
            container.innerHTML=`<tr><td colspan="5" class="text-center text-muted">No courses Found</td></tr>`;
        }
    })
